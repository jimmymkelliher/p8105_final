...
rank_vax_puma <- 
  ...
  ggplot(aes(x = fct_reorder(puma, desc(covid_vax_rate)), 
             y = covid_vax_rate)) + 
...
rank_death_puma <- 
  ...
  ggplot(aes(x = fct_reorder(puma, desc(covid_death_rate)), 
             y = covid_death_rate)) + 
  geom_bar(stat = "identity", 
           aes(fill = Borough)) + 
  theme(axis.text.x = 
...
rank_hospr_puma <- 
  ...
  ggplot(aes(x = fct_reorder(puma, desc(covid_hosp_rate)), 
             y = covid_hosp_rate)) + 
  geom_bar(stat = "identity", 
           aes(fill = Borough)) + 
  theme(axis.text.x = 
