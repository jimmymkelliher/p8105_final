...
death_income = 
  ...
  geom_point(aes(color = borough)) + 
  geom_smooth(se = FALSE, method = "lm", color = "red", aes(weight = total_people)) + 
  stat_cor(method = "pearson", label.x = 30000, label.y = 1.25) + 
  labs(
...
death_college = 
  ...
  geom_point(aes(color = borough)) + 
  geom_smooth(se = FALSE, method = "lm", color = "red", aes(weight = total_people)) + 
  stat_cor(method = "pearson", label.x = 40, label.y = 1.25) + 
  labs(
    x = "% with College Education",
    y = "% Deceased"
  ) 
...
death_citizenship = 
  ...
  geom_point(aes(color = borough)) + 
  geom_smooth(se = FALSE, method = "lm", color = "red", aes(weight = total_people)) + 
  stat_cor(method = "pearson", label.x = 20, label.y = 1.25) + 
  labs(
...
death_foreign = 
  ...
  geom_point(aes(color = borough)) + 
  geom_smooth(se = FALSE, method = "lm", color = "red", aes(weight = total_people)) + 
  stat_cor(method = "pearson", label.x = 30, label.y = 1.25) + 
  labs(
    x = "% Born Outside the US",
    y = "% Deceased"
  ) 
...
vax_welfare = 
  ...
  geom_point(aes(color = borough)) + 
  geom_smooth(se = FALSE, method = "lm", color = "red", aes(weight = total_people)) + 
  stat_cor(method = "pearson", label.x = 30, label.y = 80) + 
  labs(
    x = "% on Welfare",
    y = "% Vaccinated"
  ) + 
...
When looking at outcomes across boroughs, we saw that PUMA geographies in Queens and the Bronx tended to be above the median NYC PUMA for COVID-19 hospitalization and death rates. Interestingly, PUMA geographies in Queens were among the most highly vaccinated areas in NYC.
