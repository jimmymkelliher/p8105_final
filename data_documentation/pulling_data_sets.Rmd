...
# Should we reproduce how we obtained the health outcomes data? I encountered issues trying to find the same data table.
# We could just import what we have, but I think reproducible code would be nice.
