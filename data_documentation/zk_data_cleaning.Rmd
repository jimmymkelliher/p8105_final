...
cleaned_data = 
  ...
  select(-multyear, -rent, -hispan, -ancestr1, -ancestr2, -hcovany, -hcovpriv, -hcovpub, -labforce, -occ, -ind, -incwage, -incwelfr, -poverty, -occscore, -pwpuma00) %>% 
  # Reorder columns
  ...
  relocate(annual_rent, .before = personal_income) %>% 
