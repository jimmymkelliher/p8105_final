...
cleaned_data = 
  ...
  select(-multyear, -ancestr1, -ancestr2, -labforce, -occ, -ind, -incwage, -occscore, -pwpuma00, -ftotinc, -hcovpub, -yrsusa1) %>% 
...
predictions = round((predict(lasso_optimal, x, type = "response"))*100, 1)
...
puma_risk_score = cbind(pumas, predictions) %>% 
  knitr::kable()
```
